  ...
  return (
    <section className="pb-20">
      <div className="container">
        ...
        <h2 className="text-center font-serif text-3xl md:text-5xl mt-6">
          Featured projects
        </h2>
        <p className="text-center text-white/55 md:text-lg mt-4 max-w-md mx-auto">
      ...
      <div className="container flex flex-col gap-20 mt-10 md:mt-20">
        {portfolioProjects.map((project, index) => (
          <div
            key={index}
            className="bg-gray-800 rounded-3xl px-8 pt-6 md:px-10 md:pt-12 relative z-0 after:z-10 after:content-[''] after:absolute after:inset-0 after:rounded-3xl after:outline after:outline-2 after:-outline-offset-2 after:outline-white/20 overflow-hidden after:pointer-events-none"
          >
            <div
            ...
            <a href={project.link} className="mt-6">
              <button className="inline-flex items-center justify-center gap-2 bg-white text-gray-950 h-12 w-full rounded-xl font-semibold hover:bg-gray-100 transition-colors mt-6">
